const MESSAGES: Record<string, string> = {
  ...
  file_too_large: "This file is over the size limit. Sign in for larger uploads, or try a smaller file.",
  payload_too_large: "This file is over the size limit. Try a smaller file.",
  quota_exceeded: "You've hit your daily free limit. Sign in for a higher limit, or try again tomorrow.",
